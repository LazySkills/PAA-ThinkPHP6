...
//------------------------------------------------------------------------------
            ...
            var maxWidth = 'calc(100% - ' + me.$heading.find('.dropdown-adminmenu').children().length * me.$heading.find('.dropdown-adminmenu li').first().outerWidth() + "px)";
        ...
        minimize: function () {
            ...
            if (me.isPinned()) {
                ...
                me.$el.animate({
                    ...
                    var maxWidth = 'calc(100% - ' + me.$heading.find('.dropdown-adminmenu li>a:visible').length * me.$heading.find('.dropdown-adminmenu li>a:visible').first().outerWidth() + "px)";
                    me.$heading.find('.panel-title').css('max-width', maxWidth);
...
//            css['position'] = 'absolute';
                ...
                me.$el.animate(css, 100, function () {
                    ...
                    var maxWidth = 'calc(100% - ' + me.$heading.find('.dropdown-adminmenu li').length * me.$heading.find('.dropdown-adminmenu li').first().outerWidth() + "px)";
                    me.$heading.find('.panel-title').css('max-width', maxWidth);
        ...
        enableTooltips: function () {
            ...
            var controls = me.$heading.find('.dropdown-adminmenu>li>a');
        ...
        disableTooltips: function () {
            var me = this;
            var $links = me.$heading.find('.dropdown-adminmenu>li>a');
            ...
            // me.$heading.find('.dropdown-adminmenu>li>a').tooltip('destroy');
            return me;
        },
        ...
        _generateControls: function () {
            ...
            var menu = dropdown.find('.dropdown-adminmenu');
        ...
        _generateDropdown: function () {
            ...
            return $('<div class="dropdown"></div>')
                .append('<ul class="dropdown-adminmenu dropdown-adminmenu-right"></ul>')
